...
public class AlignTextView extends TextView {
    ...
    private final static String TAG = "AlignTextView";
    ...
    public AlignTextView(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, me.codeboy.android.aligntextview.R.styleable.AlignTextView);

        int alignStyle = ta.getInt(me.codeboy.android.aligntextview.R.styleable.AlignTextView_align, 0);
        switch (alignStyle) {
            case 1:
